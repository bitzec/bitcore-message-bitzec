...
bitcore-message-bitzec adds support for verifying and signing bitzec messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-bitzec
```

```sh
bower install bitcore-message-bitzec
```
...
var Message = require('bitcore-message-bitzec');
